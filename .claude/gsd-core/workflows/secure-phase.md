...
```
Agent(
  prompt="Read C:/Users/21093/Desktop/2/Test/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/21093/Desktop/2/Test/.claude/gsd-core/templates/SECURITY.md`
