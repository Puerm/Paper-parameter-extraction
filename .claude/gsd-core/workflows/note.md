...
- **Global scope**: `C:/Users/21093/Desktop/2/Test/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/21093/Desktop/2/Test/.claude/notes/`)
...
2. Glob `C:/Users/21093/Desktop/2/Test/.claude/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/21093/Desktop/2/Test/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/21093/Desktop/2/Test/.claude/notes/` — works in any directory
